function Calculate(){
    ...
    var ac_star=document.getElementById("ac_star").value;
    // var acPower = 1700;
    var acPower=document.getElementById("ac_star").value;
    ...
    var tv_star= document.getElementById("tv_star").value;
    // var tvPower = 70;
    var tvPower= document.getElementById("tv_star").value;
    var tvMaxPower = 350;
    ...
    var fridge_star= document.getElementById("fridge_star").value;
    // var fridgePower = 250;
    var fridgePower= document.getElementById("fridge_star").value;
    ...
    var wm_star= document.getElementById("wm_star").value;
    // var wmPower = 255;
    var wmPower= document.getElementById("wm_star").value;
    var wmMaxPower = 600;
    ...
    var geyser_star= document.getElementById("geyser_star").value;
    // var geyserPower = 2000;
    var geyserPower= document.getElementById("geyser_star").value;
    ...
    var micro_star =  document.getElementById("micro_star").value;
    // var microPower = 2500;
    var microPower =  document.getElementById("micro_star").value;
    ...
    var comp_star=  document.getElementById("comp_star").value;
    // var compPower = 1500;
    var compPower=  document.getElementById("comp_star").value;
    ...
    var blb_star=document.getElementById("blb_star").value;
    // var blbPower = 10;
    var blbPower=document.getElementById("blb_star").value;
    var blbMaxPower = 950;
    ...
    var fans_star=document.getElementById("fans_star").value;
    // var fansPower = 35;
    var fansPower=document.getElementById("fans_star").value;
    ...
    var ic_star=document.getElementById("ic_star").value;
    // var icPower = 1900;
    var icPower=document.getElementById("ic_star").value;
    var icMaxPower = 6000;
    ...
    var tube_star=document.getElementById("tube_star").value;
    // var tubePower = 15;
    var tubePower=document.getElementById("tube_star").value;
...
function Calculate(){
    ...
    //Now begins the code for calculating total expenses and usage.... 
    document.getElementById("ttlpwr").innerHTML = "Total electricity usage (in kilowatt) : " + totalUsage;
    document.getElementById("system_capacity").value = totalUsage;
